...
off in its own favour: a test module does. Eleven tests assert that all
three ship, that the two pointers stay pointers rather than becoming a
second and third set of instructions, and that every path they cite exists.
